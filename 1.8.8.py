...
def huobi():
    gui.msgbox(msg='功能开发中，即将开放。',title='货币转换',ok_button='确定', image=None, root=None)
def clock():
    ...
    hms(200)
def weather():
    url = "http://api.airvisual.com/v2/city?city=Chengdu&state=Sichuan&country=China&key=510b729a-2501-4701-b1de-74d2a4456b67"
    payload={}
    headers = {}
...
while True:
    ...
    if temp=='1':
        ...
        break
    '''
    temp=gui.choicebox(msg='请选择您需要的服务', title='超级百宝箱 1.8.8', choices=['单位换算','个人所得税计算','货币转换','时钟','天气','exit'])
    print(temp)
    if temp=='单位换算':
        danwei()
    elif temp=='个人所得税计算':
